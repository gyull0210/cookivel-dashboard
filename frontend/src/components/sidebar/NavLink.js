  ...
  const NavLink = ({ Icon, SolidIcon, name, to }) => {
    ...
    return (
      <Link to={to}>
      <div className="flex w-full my-3 md:px-1 lg:px-4 items-center relative gap-2 lg:hover:bg-gray-700 rounded-full">
        <div className="p-3 hover:bg-gray-700 rounded-full">
