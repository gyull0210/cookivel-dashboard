...
const Sidebar = ({collasped, toggleSidebar}) => {
  ...
  return (
		<aside className="fixed z-30 flex flex-col h-screen py-2 bg-gray-100 dark:bg-black shadow" ref={slidebarRef}>
      ...
      <div className={`block lg:hidden ${mobileActive  ? 'ml-0':'-ml-60'} w-60 px-4 flex flex-col justify-between flex-1 duration-200`}>
        <div className="flex flex-col flex-start items-center">         
          <div className="flex items-center mb-6 lg:ml-6">
            ...
            <span className="text-2xl font-semibold text-amber-400 p-3" onClick={handleSidebar}>
              <FaCookieBite className="hover:animate-waving"/>
            </span>
          </div>
